...
#ifndef __NAND_BSP_H__
#define __NAND_BSP_H__

/*@mhoffrog replace by local nand driver includes - FIXME*/
/*#include <nand.h> */
...
//  nand driver 版本号
//---------------------------------------------------------------
// @mhoffrog - these defs overlap with definition in nand_drv_cfg.h - FIXME*/
...
//  结构体 定义
//---------------------------------------------------------------
// @mhoffrog - those structs overlap with definition in nand_type.h - FIXME*/
...
extern int LML_Write(unsigned int nLba, unsigned int nLength, const void* pBuf);
...
extern int NAND_LogicWrite(uint nSectNum, uint nSectorCnt, const void * pBuf);
